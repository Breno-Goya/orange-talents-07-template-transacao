...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, kafkaProperties.getConsumer().getValueDeserializer());
    ...
    @Bean
    public ConsumerFactory<String, TransacaoMessage> transactionConsumeFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, TransacaoMessage> kafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(transactionConsumeFactory());
